  ...
  <head>
    ...
    <div id="gallery-viewer" class="gallery-viewer">
      <div class="viewer-container swiper">
        ...
        <div class="viewer-slide swiper-slide"><img src="{{ asset('assets/images/gallery/10.jpg') }}" alt=""></div>
        <div class="viewer-slide swiper-slide"><img src="{{ asset('assets/images/gallery/11.jpg') }}" alt=""></div>
        <div class="viewer-slide swiper-slide"><img src="{{ asset('assets/images/gallery/12.jpg') }}" alt=""></div>
        <div class="viewer-slide swiper-slide"><img src="{{ asset('assets/images/gallery/13.jpg') }}" alt=""></div>
        <div class="viewer-slide swiper-slide"><img src="{{ asset('assets/images/gallery/14.jpg') }}" alt=""></div>
        <div class="viewer-slide swiper-slide"><img src="{{ asset('assets/images/gallery/Упаковка№1.jpeg') }}" alt=""></div>
        <div class="viewer-slide swiper-slide"><img src="{{ asset('assets/images/gallery/Упаковка №2.jpeg') }}" alt=""></div>
