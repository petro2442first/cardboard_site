...
<body>
            ...
            <div class="header__container">
                <div class="header__top-panel">
                    ...
                    <nav class="nav-menu">
                        <ul class="nav-list">
                            <li class="menu-item">
                                <a href="#about-us" class="nav-link"><i class="fa fa-info-circle"
                                        aria-hidden="true"></i>Більше про
                                    нас</a>
                            </li>
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                                <a href="#contact-us" class="nav-link"><i class="fa fa-envelope"
                                        aria-hidden="true"></i>Зв'язатися з
                                    нами</a>
                            </li>
                        </ul>
                    </nav>
    ...
    <section class="block about-us" id="about-us">
        ...
        <div class="about-us__row">
            <div class="content">
                <p>Хто з нас у дитинстві не мріяв спорудити фортецю, будиночок, халабуду, з підручних матеріалів –
                    подушок, ковдр, різного роду покривал, табуреток, коробок, де можна усамітнитися, пограти зі своїми
                    іграшками чи з друзями? Діти люблять ховатися від усього світу, створюючи свій мікросвіт, в якому
                    можна почуватися комфортно і спокійно, поринути у світ мрій, веселих ігор та секретних бесід із
                    казковими героями, створити свою атмосферу, де можна бути самим собою, не зважаючи на всесвітній
                    хаос .</p>
                <p>Ми виросли і тепер це мрія наших дітей та онуків, яку можна втілити в реальність.</p>
                <h3>Мрія #1</h3>
                <p>Ми створили серію конструкторів, в яких втілені максимально можливі побажання дітей та батьків.
                    Надійність, безпека, екологічність, максимальна реалістичність, можливість будувати, розбудовувати
                    та облаштовувати. Для хлопчиків – неприступна фортеця, де вони зможуть почуватися справжніми
                    лицарями. Для дівчаток – барвистий замок. У такому замку дівчинка відчує себе прекрасною принцесою,
                    яка чекає на принца на красивому білому коні. Для любителів морських пригод – піратський корабель.
                    Для любителів космічних пригод – космічний корабель. І ще багато цікавого та загадкового. Це буде не
                    просто іграшка, а перший рівень інтерактивної гри. Для створення максимальної реальності будуть
                    запропоновані додаткові аксесуари: меблі, посуд, костюми, обладунки, зброя та багато іншого.</p>
                <h3>Мрія #2</h3>
                <p>Діти – найцінніше, що є у батьків та всього суспільства. Саме тому їхнє дитинство має бути радісним і
                    барвистим, щоб виросло щасливе та здорове покоління. Але не слід забувати, що крім подарунків та
                    сюрпризів, наші діти потребують спілкування з нами. Навіть найдорожча гра не замінить справжньої
                    присутності та уваги батьків. На другому місці у рейтингу потаємних мрій дітей — це мрія, щоб мама
                    та тато брали участь із ними в іграх, приділили їм увагу. Наші казкові замки дозволять Вам стати
                    ближчими з дітьми, брати участь у будівництві, благоустрою та житті першого особистого простору
                    Вашої дитини. Таке спілкування є запорукою щасливого дитинства Вашої дитини та Ваших онуків. Замок
                    стане чудовим подарунком, не схожим на жодний інший, і не набридне довгий час.</p>
                <h3>Мрія #3</h3>
                ...
                <p>Ви можете зберігати замки дуже просто. Вони легко складаються і легко поміщаються під ліжком, у шафі
                    чи балконі.</p>
                <p>Ви зможете придбати у нас додаткові деталі, які зможуть перетворити замок на нові об'єкти-машини,
                    літаки, кораблі та вертольоти.</p>
        ...
        <div class="catalog-item-viewer__container">
            ...
            <div class="catalog-item-viewer__col">
                ...
                <div class="catalog-item-viewer__description">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt minima eos facere porro. Deleniti
                    sint animi voluptatum ipsa molestias suscipit ipsam, atque consequuntur sunt fuga error consequatur
                    iure vero minus?
                </div>
