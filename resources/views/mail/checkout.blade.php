                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <a target="_blank" href="https://tossa-group.com"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#1376C8;font-size:14px"><img
                                                                            class="adapt-img"
                                                                            src="https://pwdrcw.stripocdn.email/content/guids/CABINET_fbe3e7a6f5fa59c7053900f503766efd/images/logo.png"
                                                                            alt
                                                    ...
                                                    <td class="es-m-p0r es-m-p20b" valign="top" align="center"
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:30px;color:#333333;font-size:20px">
                                                                        <strong>Нове замовлення&nbsp;Мрій та
                                                                            будуй</strong></p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Ім'я: {{$name}}<br>Номер телефону:
                                                                        {{$phone}}<br>Електронная пошта: {{$email}}<br>Спосіб оплати: {{$payment}}</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Сервіс доставки: {{$shipping}}<br>Область:
                                                                        {{$area}}<br>Населенний пункт:
                                                                        {{$city}}<br>Відділення: {{$warehouse}}</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
